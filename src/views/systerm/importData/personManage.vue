...
<template>
	<basePage :empty-state="true">
		<template slot="tableBox">
			<c-page ref="base" :search-type="searchType" :columns="columns" :data="list" @fetch="fetch">
...
import ImportPerson from './components/ImportPerson.vue'
...
const columns = [
	...
	},
	{
		title: '开始时间',
		width: 200,
		scopedSlots: { customRender: 'startTime', type: 'time' },
		dataIndex: 'startTime'
	},
	{
		title: '结束时间',
