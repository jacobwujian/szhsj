...
<template>
  <div class="base-page">
    <a-form-model v-if="canSearch" ref="searchForm" :model="form" :rules="rules" v-bind="formItemLayout" class="formModel">
      <a-row :gutter="[8, 8]">
        <a-col v-for="(item, index) in searchType" :key="index" :xl="8" :xxl="10">
          <!-- style="width: 400px;" -->
    ...
    <!-- children-column-name="childMenu" -->
    <a-table
      class="c-table"
