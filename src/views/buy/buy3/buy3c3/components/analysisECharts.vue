          ...
          <a-row style="height:50%">
            <a-col class="col">
              <div class="temp">
                ...
                <AnalysisByDepartment :data-list="tempData.Department" :d-grid-size="33" @queryData="queryData" />
              </div>
            </a-col>
          </a-row>
...
import AnalysisByCommodityCategory from '@/components/charts/components/analysisByCommodityCategory'
