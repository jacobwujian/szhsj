<template>
  <basePage :loading="loading" :empty-state="emptyState">
    ...
    <template slot="chart">
      <AnalyTitle title-name="赊账金额异动分析" :refresh-status="false" @refresh="queryData" />
...
const columns = [
  ...
  },
  {
    ...
    dataIndex: 'beDate',
    width: 150,
    scopedSlots: { customRender: 'beDate', type: 'time', format: 'YYYY-MM-DD' }
  },
  {
    title: '额度截止日期',
    dataIndex: 'leDate',
    width: 150,
    scopedSlots: { customRender: 'leDate', type: 'time', format: 'YYYY-MM-DD' }
  },
  {
    title: '额度类型',
    dataIndex: 'creditType',
    width: 150,
    scopedSlots: { customRender: 'creditType', type: 'select', data: creditType }
  },
  {
    title: '公司客商',
    dataIndex: 'ccodeName',
